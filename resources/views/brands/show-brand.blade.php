    ...
    <div class="container">
      ...
      <div class="wrapper-main">
        <div class="brand-image-slider slider">
          ...
          <div class="slide">
            <a href="{{ asset($image->image_path) }}" data-caption="Brand Image {{ $index + 1 }}" data-fancybox="brandImages">
              <div class="brand-images" style="background-image: url('{{ asset($image->image_path) }}')"></div>
            </a>
          </div>
          @endforeach
        </div>
